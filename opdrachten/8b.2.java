...
public class CuriousBehavior08 extends Behavior {
	...
	public CuriousBehavior08(BaseController initJoBot,
	...
	public void doBehavior() {
		...
		if (state == stateActWander) {
			...
			if (wait-- > 0)  nextState = stateActWander;
			// Klaarzetten voor volgende cycle
