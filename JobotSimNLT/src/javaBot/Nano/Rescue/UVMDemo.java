...
public class UVMDemo extends UVMRunnable implements AgentWebService,
	...
	private String DIP = "0=Idle ,1=Calib,2=Drive,3=     ,4=Curio,5=     ,6=     ,7=     ,8=Line ";
	...
	public void processState(int dipValue) {
		...
		//		Opdracht 11 - Maak een lijnvolger met obstakeldetectie (extra opdracht)
	...
	public void run() {
		System.out.println("UVMdemo Nano NLT Rescue V400");
		try {
...
//			The function setPortBDIP in NanoRobot is responsible for this.
	...
	private void showDIP (int dipValue) {
		if (dipValue == 0)
	        System.out.println("1=Cal,2=Drive,4=Curious,8=Line");
